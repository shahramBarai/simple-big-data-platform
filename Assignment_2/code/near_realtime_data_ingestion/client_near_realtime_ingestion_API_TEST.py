...
def parse_args():
    ...
    parser.add_argument('-i', '--input_file', help='Set the path of the dataset to ingest including file extension')
    parser.add_argument('-c', '--chunk_size', help='Chunk size for big file')
